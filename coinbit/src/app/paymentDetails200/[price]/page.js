            ...
            <div className="bg-white rounded-xl p-5 max-[450px]:p-3 w-[500px] ">
                <div className="flex flex-col gap-5">
                    ...
                    <div  className="flex gap-5 items-center">
                        ...
                        <h4 className="font-bold">$5000 USD</h4>
                    </div>
                    <div  className="flex gap-5 items-center">
                        <h4 className="max-[450px]:text-[13px]">Sum Total :</h4>
                        <h4 className="font-bold">${parseInt(params.price) + 4800} USD</h4>
                    </div>
                    <div  className="flex gap-5 items-center">
                        <h4 className="max-[450px]:text-[13px]">Proposed Transaction Duration :</h4>
                        <h4 className="font-bold">10 mins</h4>
                    </div>
                    <Link href={ `/verifyPayment200/${amtConversion}`}><button className="bg-gradient-to-tl from-blue-900 to-black text-white p-2 flex w-full justify-center rounded-full">Continue to Payment</button></Link>
                </div>
            </div>
        </div>
     );
