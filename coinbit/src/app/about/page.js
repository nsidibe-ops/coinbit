        ...
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[650px]:px-20 max-[550px]:px-10 pt-28">
            <div className=" flex max-[950px]:flex-col justify-center gap-5">
                ...
                <p className="text-[13px] mb-5 leading-loose">
                    ...
                    For more details about bitcoin and how it works click <Link href="https://youtu.be/41JCpzvnn_0?si=drg14BHm1s_ZCsTq"> <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500 border-b-[1px]">here</span> </Link> <br/>
                </p>
            ...
            <div className="flex max-[550px]:flex-col gap-5 text-white mx-5 mb-10">
                ...
                <div className="w-[500px] max-[550px]:w-full">
            ...
            <div className=" flex flex-col justify-center items-center gap-5 mt-20 text-white">
                ...
                <p className="text-center text-sm leading-loose text-slate-500 w-[800px] max-[850px]:w-[500px] max-[550px]:w-full  mb-5">Each review is especially valuable to us. After all, a long joint path has been done for this. Success consists of trust, willingness to develop and change.</p>
            </div>
                <Reviews />
            </div>
        </div>
