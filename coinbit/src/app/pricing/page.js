            ...
            <div className='flex  max-[825px]:flex-col justify-center items-center mt-20 gap-5'>
                <div className='flex flex-col max-[825px]:w-full gap-3 bg-white p-5 rounded-lg'>
                    <div className=''>
                        ...
                        <h3 className='text-5xl p-3 shadow-sm shadow-slate-400 my-3 w-72 max-[1100px]:w-60 max-[910px]:w-52 max-[825px]:w-full max-[910px]:text-4xl rounded-lg text-black'>$50-$1000</h3>{/*$200*/}
                    </div>
                    <div className='flex flex-col gap-3'>
                        <span className='flex items-center gap-2'><BsCheck2All /><p>12% Returns</p></span>
                        ...
                        <span className='flex items-center gap-2'><BsCheck2All /><p>$10 investment bonus</p></span>
                    </div>
                ...
                <div className='flex flex-col max-[825px]:w-full gap-3 bg-white p-5 rounded-lg shadow-md shadow-slate-500'>
                    <div className=''>
                        ...
                        <h3 className='text-5xl p-3 shadow-sm shadow-slate-400 my-3 w-72 max-[1100px]:w-60 max-[910px]:w-52 max-[825px]:w-full max-[910px]:text-4xl rounded-lg'>$1000-$5000</h3> {/*$1200*/}
                    </div>
                    <div className='flex flex-col gap-5'>
                        <span className='flex items-center gap-2 '><BsCheck2All /><p>16% Returns</p></span>
                        <span className='flex items-center gap-2'><BsCheck2All /><p>48 hours duration</p></span>
                    ...
                    <Link href="/paymentDetails100/100"><button className="bg-blue-900 p-3 w-full rounded-lg text-white mt-12 font-semibold text-[13px]">Invest Plan</button></Link>
                </div>
                <div className='flex flex-col max-[825px]:w-full gap-3 bg-white p-5 rounded-lg'>
                    <div className=''>
                        <h3 className='text-2xl font-semibold mb-1'>Premium</h3>
                        <p className='text-[13px] '>Big investors investment</p>
                        <h3 className='text-5xl p-3 shadow-sm shadow-slate-400 my-3 w-72 max-[1100px]:w-60 max-[910px]:w-52 max-[825px]:w-full max-[910px]:text-4xl rounded-lg'>$5000-$15000</h3>{/*$2500*/}
                    </div>
                    <div className='flex flex-col gap-3'>
                        <span className='flex items-center gap-2'><BsCheck2All /><p>35% Returns</p></span>
                    ...
                    <Link href="/paymentDetails200/200"> <button className="bg-blue-900 p-3 w-full rounded-lg text-white mt-5 font-semibold text-[13px]">Invest Plan</button></Link>
                </div>
            </div>
