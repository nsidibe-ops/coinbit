            ...
            <div className="w-full">
                ...
                <div className="flex gap-10 max-[800px]:gap-5 mt-5">
                    <div className="bg-white text-black w-72 h-28 rounded-lg flex flex-col justify-center pl-5 max-[580px]:pl-2   gap-3">
                        ...
                        <h2 className="text-4xl max-[950px]:text-3xl max-[752px]:text-xl font-semibold ">$50</h2>{/*1200*/}
                    </div>
                    <div className="bg-white text-black w-72 h-28 rounded-lg flex flex-col justify-center pl-5 max-[580px]:pl-2 gap-3">
                        <span className="flex gap-1 items-center">
                        ...
                        <h2 className="text-4xl max-[950px]:text-3xl max-[752px]:text-xl font-semibold">$100</h2>{/*3000*/}
                    </div>
                    <div className="bg-white text-black w-72 h-28 rounded-lg flex flex-col justify-center pl-5 max-[580px]:pl-2 gap-3">
                        <span className="flex gap-1 items-center">
