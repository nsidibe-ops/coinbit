...
const Contact = () => {
    function text(){
        alert("Thanks for reaching out, we would get back to you as soon as possible.");
    }
    return ( 
        <div  className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[875px]:px-20 max-[700px]:px-10  max-[420px]:px-5 max-[800px]:pt-32 max-[770px]:pt-28 pt-28 flex max-[770px]:flex-col min-[770px]:items-center min-[770px]:justify-center text-white min-[770x]:h-screen">{/*pl-72 h-screen*/ }
            <div className="w-1/2 max-[770px]:w-full">
                ...
                <Link href="https://wa.link/7v56p1"><button className="bg-white text-black p-2 w-40 max-[400px]:w-28  max-[400px]:text-[10px] rounded-2xl flex items-center gap-1"><IoLogoWhatsapp className="text-lg text-green-800"/>Via WhatsApp</button></Link>
